...
import { toSubmissionRow } from "../../submissions/[submissionId]/page";
import { SubmissionStatusBadge } from "@/app/components/submissions/SubmissionsList";
...
export default function ResourceSubmissionDetailPage() {
  ...
  function restoreDocumentFromSubmission() {
    ...
    setDocumentText(
      questionsToDocument(
        submission.questions.map((q: any) => q.question ?? q),
      ),
    );
    setMode("view");
  }
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <ListCard
        ...
        metaData={formatDisplayDate(submission.interview.interviewDate)}
        badge={
          <SubmissionStatusBadge submission={toSubmissionRow(submission)} />
        }
        styles={{ cursor: "auto" }}
      />
